            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(com.dev.insta.PostActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                    }
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(com.dev.insta.PostActivity.this, ""+ e.getMessage(), Toast.LENGTH_SHORT).show();
